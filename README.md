...
There are other interesting repositories for automation such as [Zelda Snowball-thrower](https://github.com/bertrandom/snowball-thrower) and [Splatoon 2 post printer](https://github.com/shinyquagsire23/Switch-Fightstick). In my case, the primary use was automating Pokemon shiny hunting, combined with a separate project that used a capture card and opencv to read the game screen.
